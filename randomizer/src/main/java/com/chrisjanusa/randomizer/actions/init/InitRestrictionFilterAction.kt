...
import com.chrisjanusa.randomizer.actions.filter.restriction.RestrictionUpdater
...
class InitRestrictionFilterAction :BaseAction {
    override suspend fun performAction(
        ...
        eventChannel: Channel<BaseEvent>
         ...
         currentState.value?.run {  updateChannel.send(RestrictionUpdater(restriction)) }
    }
