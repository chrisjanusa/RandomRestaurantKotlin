    ...
    private val render = fun(newState: RandomizerState) {
        context?.let {
            newState.categoryTempSet.run {
                renderCategoryOptionCardStyle(american, american_description, american_icon, contains(Category.American), it)
                ...
                renderCategoryOptionCardStyle(desserts, desserts_description, desserts_icon, contains(Category.Dessert), it)
                renderCategoryOptionCardStyle(italian, italian_description, italian_icon, contains(Category.Italian), it)
                renderCategoryOptionCardStyle(indian, indian_description, indian_icon, contains(Category.Indian), it)
                renderCategoryOptionCardStyle(mexican, mexican_description, mexican_icon, contains(Category.Mexican), it)
                renderCategoryOptionCardStyle(pizza, pizza_description, pizza_icon, contains(Category.Pizza), it)
                renderCategoryOptionCardStyle(seafood, seafood_description, seafood_icon, contains(Category.Seafood), it)
