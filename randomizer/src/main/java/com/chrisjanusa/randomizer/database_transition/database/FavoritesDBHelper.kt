...
class FavoritesDBHelper(context: Context) : SQLiteOpenHelper(
    context,
    favoritesDatabaseName, null,
    databaseVersion
) {
    ...
    fun getFavoriteRestaurants(): List<DatabaseRestaurant> {
        try {
    ...
    companion object {
        ...
        const val favoritesDatabaseName = "restaurantsDB.db"
