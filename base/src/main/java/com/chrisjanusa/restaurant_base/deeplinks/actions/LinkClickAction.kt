...
import com.chrisjanusa.restaurant_base.deeplinks.events.OpenLinkEvent
import kotlinx.coroutines.channels.Channel

class LinkClickAction(private val url: String) : BaseAction {
    override suspend fun performAction(
        ...
        eventChannel.send(OpenLinkEvent(url))
    }
}